...
const Footer = () => {
  return (
    ...
    <div className="flex">
                    <p className="font-bold text-center text-pink-500 text-xl">
                        Made<span className="text-pink-500 text-xl">With</span>
                        <span className="text-pink-500 text-xl">Love</span>
                    </p>
                </div>
                <div className="">
                    <p>QUICK LINKS</p>
            ...
            <div className="flex items-center justify-center py-10">
                <span className="text-gray-400 leading-10">Made With Love official: 2023</span>
